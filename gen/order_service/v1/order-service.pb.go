...
const file_order_service_v1_order_service_proto_rawDesc = "" +
	...
	"\x15ORDER_STATUS_REJECTED\x10\x05*P\n" +
	"\tOrderType\x12\x1a\n" +
	...
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponseB\x8e\x01\n" +
	"\tcom.orderB\x11OrderServiceProtoP\x01Z:github.com/ckjkee/proto-main/gen/order-service/v1;order_v1\xa2\x02\x03OXX\xaa\x02\x05Order\xca\x02\x05Order\xe2\x02\x11Order\\GPBMetadata\xea\x02\x05Orderb\x06proto3"
...
var file_order_service_v1_order_service_proto_depIdxs = []int32{
	...
	1, // 1: order.CreateOrderRequest.order_type:type_name -> order.OrderType
	0, // 2: order.CreateOrderResponse.order_status:type_name -> order.OrderStatus
	2, // 3: order.OrderService.GetOrderStatus:input_type -> order.GetOrderStatusRequest
	4, // 4: order.OrderService.CreateOrder:input_type -> order.CreateOrderRequest
	3, // 5: order.OrderService.GetOrderStatus:output_type -> order.GetOrderStatusResponse
